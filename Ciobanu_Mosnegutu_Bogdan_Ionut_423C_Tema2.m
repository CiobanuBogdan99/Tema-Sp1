D=4;%Durata semanlului egala cu numarul meu din lista
...
C(k+N+1) = integral(@(t)((abs(sawtooth(w*t,0.1))+sawtooth(w*t,0.1)))/2.*exp(-1j*k*w*t),0,T);
...
%Seriile Fourier sunt o unealtã matematicã folositã pentru a analiza func?iile periodice descompunându-le într-o sumã ponderatã
%de func?ii sinusoidale componente care sunt denumite armonice.
%Cu ajutorul seriei Fourier complexa am reprezentat spectrul de amplitudini
%al semnalului si am reprezenta grafic semnalul
